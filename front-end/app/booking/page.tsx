...
export default function BookingPage() {
  ...
  const handleBookingConfirm = async () => {
    try {
      ...
      console.log("Booking response:", bookingDataResult);
...
//         // Lấy scheduleId từ court-services
//         const scheduleResponse = await fetch(
//           `http://localhost:8080/api/sub-court-schedules/get-schedule-id?subCourtId=${
//             paymentResult.subCourtId
//           }&date=${
//             paymentResult.startTime.split("T")[0]
...
//         if (scheduleData && scheduleResponse.ok) {
//           const scheduleId = scheduleData; // Giả sử API trả về scheduleId

//           // Cập nhật trạng thái lịch sân
//           const updateResponse = await fetch(
//             `http://localhost:8080/api/sub-court-schedules/update-status/${scheduleId}/${paymentResult.subCourtId}`,
//             {
//               method: "PUT",
//               headers: { "Content-Type": "application/json" },
...
//             throw new Error("Cập nhật trạng thái lịch sân thất bại");
//           }

//           // Chuyển hướng về dashboard với thông báo thành công
//           router.push(
//             `/dashboard?message=${encodeURIComponent(paymentResult.message)}`
//           );
//         } else {
//           throw new Error("Không thể lấy scheduleId");
//         }
//       } else {
//         throw new Error(paymentResult.error || "Khởi tạo thanh toán thất bại");
//       }
//     } catch (error: any) {
//       console.error("Error details:", error.message);
//       toast.error(error.message || "Đặt sân thất bại");
